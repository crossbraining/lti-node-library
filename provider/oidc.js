...
const { platformSchema } = require("../Provider/registerPlatform");
...
function create_oidc_response(req, res) {
  ...
  Database.Get("platforms", platformSchema, {
    consumerUrl: req.session.login_request.iss,
  })
    .then((dbResult) => {
